...
function fakeMessage() {
    $('<div class="message new"><figure class="avatar"><img src="fireprofile.png" /></figure>안녕하시오. 무슨일로 찾아왔소?</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();H
    updateScrollbar();
}
...
async function sendMessage() {
    ...
    try {
        const response = await fetch('http://localhost:3007/fortuneTell', {
            method: 'POST',
            headers: {
